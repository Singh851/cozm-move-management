import { Bell, Search, Menu, MessageSquare, HelpCircle, Settings } from "lucide-react";
  ...
  return (
    <div className="flex h-16 w-full items-center justify-between border-b border-slate-200 bg-white px-4 fixed top-0 z-50">
      <div className="flex items-center gap-4 h-full">
        <div className={`flex items-center h-full transition-all duration-300 ${collapsed ? "w-8" : "w-56"}`}>
          <div className="flex items-center justify-center font-display font-bold text-xl text-primary-600 tracking-tight gap-2">
            {!collapsed ? (
              <>
